...
- **Referenced scripts**:
  ...
  - Make sure scripts respect `.env` file follow this order: `process.env` > `$HOME/.claude/skills/${SKILL}/.env` > `$HOME/.claude/skills/.env` > `$HOME/.claude/.env` 
...
- Make sure scripts respect `.env` file follow this order: `process.env` > `$HOME/.claude/skills/docs-seeker/.env` > `$HOME/.claude/skills/.env` > `$HOME/.claude/.env`
...
- [Agent Skills Spec]($HOME/.claude/skills/agent_skills_spec.md)
